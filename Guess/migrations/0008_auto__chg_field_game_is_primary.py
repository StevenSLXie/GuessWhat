...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.is_primary'
        db.alter_column(u'Guess_game', 'is_primary', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Game.is_primary'
        db.alter_column(u'Guess_game', 'is_primary', self.gf('django.db.models.fields.BooleanField')())
