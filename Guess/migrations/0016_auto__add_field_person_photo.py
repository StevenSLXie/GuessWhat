...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'Guess_person', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(default='settings.MEDIA_ROOT/cat.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.photo'
        db.delete_column(u'Guess_person', 'photo')
    ...
    models = {
        ...
        u'Guess.person': {
            ...
            'photo': ('django.db.models.fields.files.FileField', [], {'default': "'settings.MEDIA_ROOT/cat.jpg'", 'max_length': '100'}),
