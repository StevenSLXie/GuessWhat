...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Guess_proposal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Guess.Person'])),
            ('game_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('game_cate', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'Guess', ['Proposal'])


    def backwards(self, orm):
        # Deleting model 'Proposal'
        db.delete_table(u'Guess_proposal')
