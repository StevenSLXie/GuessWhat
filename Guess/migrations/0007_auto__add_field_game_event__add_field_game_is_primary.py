...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.event'
        db.add_column(u'Guess_game', 'event',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Game.is_primary'
        db.add_column(u'Guess_game', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.event'
        db.delete_column(u'Guess_game', 'event')

        # Deleting field 'Game.is_primary'
        db.delete_column(u'Guess_game', 'is_primary')
