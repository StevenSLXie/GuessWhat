...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Guess_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Guess.Person'])),
            ('betting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Guess.Betting'])),
            ('verbal', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Guess', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'Guess_message')
    ...
    models = {
        ...
        u'Guess.game': {
            ...
            'game_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
