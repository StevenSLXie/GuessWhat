...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field expertise on 'Person'
        m2m_table_name = db.shorten_name(u'Guess_person_expertise')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'Guess.person'], null=False)),
            ('persontag', models.ForeignKey(orm[u'Guess.persontag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['person_id', 'persontag_id'])

        # Adding M2M table for field game_tag on 'Game'
        m2m_table_name = db.shorten_name(u'Guess_game_game_tag')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('game', models.ForeignKey(orm[u'Guess.game'], null=False)),
            ('gametag', models.ForeignKey(orm[u'Guess.gametag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['game_id', 'gametag_id'])


    def backwards(self, orm):
        # Removing M2M table for field expertise on 'Person'
        db.delete_table(db.shorten_name(u'Guess_person_expertise'))

        # Removing M2M table for field game_tag on 'Game'
        db.delete_table(db.shorten_name(u'Guess_game_game_tag'))
