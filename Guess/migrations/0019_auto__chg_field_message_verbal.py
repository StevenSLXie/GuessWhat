...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.verbal'
        db.alter_column(u'Guess_message', 'verbal', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Message.verbal'
        db.alter_column(u'Guess_message', 'verbal', self.gf('django.db.models.fields.CharField')(max_length=300))
