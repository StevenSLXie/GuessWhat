...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Guess_comments', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_whom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Guess.Person'])),
            ...
            ('disliked', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Guess', ['Comments'])


    def backwards(self, orm):
        # Deleting model 'Comments'
        db.delete_table(u'Guess_comments')
