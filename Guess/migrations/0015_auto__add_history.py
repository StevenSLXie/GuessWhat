...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Guess_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cur_price', self.gf('django.db.models.fields.FloatField')()),
            ('cur_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Guess.Game'])),
        ))
        db.send_create_signal(u'Guess', ['History'])


    def backwards(self, orm):
        # Deleting model 'History'
        db.delete_table(u'Guess_history')
