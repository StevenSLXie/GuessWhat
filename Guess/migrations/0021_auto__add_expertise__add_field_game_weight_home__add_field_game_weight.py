...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Guess_expertise')

        # Deleting field 'Game.weight_home'
        db.delete_column(u'Guess_game', 'weight_home')

        # Deleting field 'Game.weight_away'
        db.delete_column(u'Guess_game', 'weight_away')

        # Deleting field 'Betting.buy_time'
        db.delete_column(u'Guess_betting', 'buy_time')

        # Deleting field 'Betting.sell_time'
        db.delete_column(u'Guess_betting', 'sell_time')

        # Deleting field 'Betting.win'
        db.delete_column(u'Guess_betting', 'win')
    ...
    models = {
        u'Guess.betting': {
            ...
            'buy_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
            ...
            'sell_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
        ...
        u'Guess.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
