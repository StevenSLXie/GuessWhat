...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comments.post_time'
        db.add_column(u'Guess_comments', 'post_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comments.post_time'
        db.delete_column(u'Guess_comments', 'post_time')
    ...
    models = {
        u'Guess.betting': {
            ...
            'buy_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)'}),
            ...
            'sell_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)'}),
        ...
        u'Guess.comments': {
            ...
            'disliked': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'from_whom': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Guess.Person']"}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Guess.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'liked': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)'})
        },
        u'Guess.expertise': {
        ...
        u'Guess.message': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)'}),
        ...
        u'Guess.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)'}),
