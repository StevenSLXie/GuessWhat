...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.joined'
        db.add_column(u'Guess_person', 'joined',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Person.title'
        db.add_column(u'Guess_person', 'title',
                      self.gf('django.db.models.fields.CharField')(default='\xe6\x96\xb0\xe4\xba\xba', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.joined'
        db.delete_column(u'Guess_person', 'joined')

        # Deleting field 'Person.title'
        db.delete_column(u'Guess_person', 'title')
    ...
    models = {
        ...
        u'Guess.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 25, 0, 0)'}),
