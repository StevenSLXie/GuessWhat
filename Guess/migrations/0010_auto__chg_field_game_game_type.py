...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.game_type'
        db.alter_column(u'Guess_game', 'game_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Game.game_type'
        db.alter_column(u'Guess_game', 'game_type', self.gf('django.db.models.fields.TextField')())
