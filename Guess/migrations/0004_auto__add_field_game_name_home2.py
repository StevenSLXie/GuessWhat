...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.name_home2'
        db.add_column(u'Guess_game', 'name_home2',
                      self.gf('django.db.models.fields.CharField')(default='Graduate', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.name_home2'
        db.delete_column(u'Guess_game', 'name_home2')
    ...
    models = {
        ...
        u'Guess.game': {
            ...
            'name_home2': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
